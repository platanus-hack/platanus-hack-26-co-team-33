...
4. **Ves la plata entrar y la retiras.** Dashboard con revenue, pagos por agente (wallet + tx en el explorer) y retiros on-chain con un botón.
...
- Retiros on-chain confirmados desde el dashboard en producción
...
```bash
# un agente paga por el pronóstico de Bogotá a través de Peaje
