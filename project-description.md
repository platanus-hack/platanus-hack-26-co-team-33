...
4. **Ves la plata entrar.** Dashboard con revenue en vivo y pagos por agente (wallet + tx en el explorer). Retiros on-chain: la lógica y la API ya funcionan (probadas con transacciones reales); el botón en el dashboard llega en el próximo sprint.
...
- Retiros on-chain probados end-to-end (API + treasury); el botón en el dashboard llega pronto
