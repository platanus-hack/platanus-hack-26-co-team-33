...
4. **Ves la plata entrar.** Dashboard con revenue en vivo y pagos por agente (wallet + tx en el explorer). Retiros on-chain: la lógica y la API ya funcionan, probadas con transacciones reales — feature disponible pronto en el dashboard.
...
- Retiros on-chain probados end-to-end (API + treasury) — feature disponible pronto en el dashboard
